...
const BASE_URL = process.env.NEXT_PUBLIC_BASE_URL || 'https://audiscribe.com';
const SITE_NAME = 'Audiscribe';
const DESCRIPTION = 'Lightning-fast audio transcription API powered by M4 Metal. 80% cheaper and 3x faster than cloud alternatives. Start with 60 free minutes per month.';
...
export const metadata: Metadata = {
  ...
  // Basic metadata
  title: {
    default: 'Audiscribe - 80% Cheaper Audio Transcription API',
  ...
  authors: [{ name: 'Audiscribe Team', url: BASE_URL }],
  creator: 'Audiscribe',
  publisher: 'Audiscribe',
  ...
  openGraph: {
    ...
    url: BASE_URL,
    siteName: SITE_NAME,
    title: 'Audiscribe - 80% Cheaper Audio Transcription API',
    description: DESCRIPTION,
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Audiscribe - Fast and Affordable Audio Transcription',
        type: 'image/png',
      },
      {
      ...
      <div className="section-container">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-900">Audiscribe</span>
          </Link>
    ...
    <footer className="bg-gray-50 border-t border-gray-200 mt-20">
      <div className="section-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-600 text-sm">
              Lightning-fast, affordable audio transcription powered by M4 Metal.
            </p>
          </div>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 text-sm">
            © {new Date().getFullYear()} Audiscribe. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="https://twitter.com/audiscribe" className="text-gray-400 hover:text-gray-600">
              <span className="sr-only">Twitter</span>
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
              </svg>
            </a>
            <a href="https://github.com/audiscribe" className="text-gray-400 hover:text-gray-600">
